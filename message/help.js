...
│⦿ ${i.free}  ${prefix}tutorial
│⦿ ${i.free}  ${prefix}sewabot
│⦿ ${i.free}  ${prefix}simplemenu
│⦿ ${i.free}  ${prefix}owner
└────────────────────〙
┌──〘 TOOLS 〙
...
└────────────────────〙
┌──〘 DOWNLOAD 〙
│⦿ ${i.limit} ${prefix}ytmp4 link
│⦿ ${i.limit} ${prefix}ytmp3 link
│⦿ ${i.limit} ${prefix}igdl link
│⦿ ${i.limit} ${prefix}fbdl link
│⦿ ${i.limit} ${prefix}yts judul
│⦿ ${i.limit} ${prefix}play judul
│⦿ ${i.limit} ${prefix}playmp4 judul 
└────────────────────〙
┌──〘 STALKER 〙
