    ...
    try {
        ...
        switch(command){
            case 'prefix': case 'cekprefix':{
                ...
                break
            case prefix+'help': case prefix+'menu': case prefix+'allmenu':{
...
//------------------< INFO >-------------------
            ...
            case prefix+'creator':
                ...
                .then((res) => xinz.sendMessage(from, 'Tuh kontak ownerku kak', text, {quoted: res}))
                break
            case prefix+'ping':
            case prefix+'speed':{
                let timestamp = speed();
            ...
            case prefix+'donate': case prefix+'donasi':
                ...
                break
            case prefix+'tutorial': case prefix+'sc': case prefix+'src':
                textImg(`Cara Membuat Bot WhatsApp Dari Termux : https://youtube.com/channel/UCnEE30s4Rz6XczhVaZXX0XQ`)
                break
            case prefix+'rules': case prefix+'peraturan':
                textImg(`*「 PERATURAN BOT 」*
...
└────────────────────〙`)
                break
            case prefix+'stalkermenu':
                textImg(`┌──〘 STALKER-MENU 〙
...
└────────────────────〙`)
                break
            case prefix+'baileysmenu':
                textImg(`┌──〘 BAILEYS-MENU 〙
│⦿ ${i.free} ${prefix}tagme
